...
Task-oriented documentation for the duckLM regression macros. For a one-page
signature reference see [CHEATSHEET.md](CHEATSHEET.md); for install/setup see the
[README](README.md).

- [Fitting](#fitting)
- [Predicting & prediction intervals](#predicting)
- [Evaluating](#evaluating)
- [Inference: standard errors, p-values, confidence intervals](#inference)
- [Influence diagnostics](#influence-diagnostics)
- [Multiclass (multinomial)](#multiclass)
