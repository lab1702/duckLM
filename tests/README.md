...
families (including Tweedie across powers, multinomial softmax, offset/exposure,
and sample weights), ridge/lasso/elastic-net with the documented sklearn equivalences
